            ...
            submenu: [
                {
                    ...
                    label: 'Tell us about a bug',
                    click() {
                        shell.openExternal('https://github.com/repl-it-discord/repl-it-electron/issues/new?assignees=&labels=&template=bug_report.md&title=').then();
                    }
                }
            ]
        }
